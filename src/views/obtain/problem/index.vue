    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['obtain:problem:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['obtain:problem:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['obtain:problem:export']"
        >导出</el-button>
      </el-col>
...
<!--      <el-table-column label="问题编号" align="center" prop="problemId"/>-->
      <el-table-column label="截图/照片" align="center" prop="problemPath" width="100">
        <template slot-scope="scope">
          <image-preview :src="scope.row.problemPath" :width="50" :height="50"/>
        </template>
      </el-table-column>
      <el-table-column label="问题描述" align="center" prop="problemContent" width="280" show-overflow-tooltip>
        <template slot-scope="scope">
          <span v-html="scope.row.problemContent"></span>
        </template>
      </el-table-column>
<!--      <el-table-column label="学生外键" align="center" prop="studentId" />-->
<!--      <el-table-column label="备注" align="center" prop="remark" />-->
    ...
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body :before-close="cancel">
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        ...
        <el-row>
          <el-col :span="12">
        <el-form-item label="截图/照片" prop="problemPath">
          <image-upload v-model="form.problemPath"/>
        </el-form-item>
          </el-col>
        </el-row>
        <el-row>
        ...
        <el-form-item label="问题描述" prop="problemContent">
          <editor v-model="form.problemContent" :min-height="192" style="width: 600px"/>
        </el-form-item>
          </el-col>
        </el-row>
      </el-form>
...
<script>
import { listProblem, getProblem, delProblem, addProblem, updateProblem } from "@/api/obtain/problem";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        studentId: [
          { required: true, message: "必须选择学生", trigger: "blur" }
        ],
      }
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除就业问题反馈编号为"' + problemIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('obtain/problem/export', {
        ...this.queryParams
