<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="市场部名称" prop="marketName">
        <el-input
          v-model="queryParams.marketName"
          placeholder="请输入市场部名称"
          clearable
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['obtain:market:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['obtain:market:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="marketList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="市场部编号" align="center" prop="marketId" />
      <el-table-column label="市场部名称" align="center" prop="marketName" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="市场部名称" prop="marketName">
          <el-input v-model="form.marketName" placeholder="请输入市场部名称" />
        </el-form-item>
        <el-form-item label="状态" prop="status">
...
<script>
import { listMarket, getMarket, delMarket, addMarket, updateMarket } from "@/api/obtain/market";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        marketName: [
          { required: true, message: "市场部名称不能为空", trigger: "blur" }
        ],
      }
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除市场部管理编号为"' + marketIds + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('obtain/market/export', {
        ...this.queryParams
